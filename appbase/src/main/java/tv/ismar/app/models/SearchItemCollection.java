 ...
 * Remember NEVER USE {@link SearchItemCollection#objects} 's size() method
 * to get the total size of the ItemCollection. Use {@link SearchItemCollection#count} instead.
 * @author bob
 *
 */
