...
public class PackageDetailFragment extends BaseFragment {
    ...
    private View.OnClickListener mRelatedClickListener =
    ...
    private RecyclerViewTV.OnItemClickListener PackageItemClickListener =
    ...
    private void initView() {
        ...
        vod_payment_pacakge_title =
                (TextView) rootView.findViewById(R.id.vod_payment_pacakge_title);
        vod_payment_packageDescribe_content =
                (TextView) rootView.findViewById(R.id.vod_payment_packageDescribe_content);
        mRelatedVideoContainer = (LinearLayout) rootView.findViewById(R.id.related_video_container);
        vod_payment_item_of_package_container =
                (RecyclerViewTV) rootView.findViewById(R.id.vod_payment_item_of_package_container);
        ...
        vod_payment_buyButton.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        PageIntent pageIntent = new PageIntent();
                        PaymentInfo paymentInfo =
                                new PaymentInfo(Package, mItemEntity.getPk(), PAYMENT);
                        pageIntent.toPaymentForResult(getActivity(), "package", paymentInfo);
                    }
                });
        vod_payment_item_more.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        PageIntent pageIntent = new PageIntent();
    ...
    private void loadView() {
        if (mItemEntity != null) {
            ...
            if (mItemEntity.getItems().isEmpty()) {
                ...
                vod_payment_item_of_package_container.setLayoutManager(
                ...
                vod_payment_item_of_package_container.addItemDecoration(
                        new SpacesItemDecoration(
                                getResources()
                                        .getDimensionPixelSize(
                                                R.dimen.package_detail_list_item_margin_left)));

                vod_payment_item_of_package_container.setOnItemClickListener(
                        PackageItemClickListener);
            }

            Picasso.with(getContext()).load(mItemEntity.getAdletUrl()).into(vod_payment_poster);

            fetchRelated(mItemEntity.getPk());
            if (itemEntities != null && !itemEntities.isEmpty()) {
                vod_payment_item_of_package_container.setAdapter(
                        new PackageItemAdapter(getContext(), itemEntities));
            }
        }
    }
                        ...
                        mActivity.new BaseObserver<ItemEntity[]>() {
                            ...
                            public void onNext(ItemEntity[] itemEntities) {
                                ...
                                if (((DetailPageActivity) getActivity()).mLoadingDialog != null
                                        && ((DetailPageActivity) getActivity())
    ...
    private void buildRelatedList() {
        ...
        for (ItemEntity relatedItem : relatedList) {
            RelativeLayout relatedHolder =
                    (RelativeLayout)
                            LayoutInflater.from(getContext())
                                    .inflate(R.layout.item_related_layout, null);
            ...
            ImageView qualityLabel =
                    (ImageView) relatedHolder.findViewById(R.id.related_quality_label);
            TextView related_price_txt =
                    (TextView) relatedHolder.findViewById(R.id.related_price_txt);
    ...
    private void refreshPayInfo(PlayCheckEntity playCheckEntity) {
        ...
        if (remainDay > 0) {
            ...
            vod_payment_duration.setBackgroundResource(
                    R.drawable.vod_detail_already_payment_duration);
    ...
    private class PackageItemAdapter extends RecyclerView.Adapter<PackageItemViewHolder> {
        ...
        public void onBindViewHolder(PackageItemViewHolder holder, int position) {
            ...
            Picasso.with(mContext)
                    .load(item.getAdletUrl())
                    .error(R.drawable.error_hor)
    ...
    private class PackageItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public PackageItemViewHolder(View itemView) {
            ...
            final ImageView ItemdefaultImage =
                    (ImageView) itemView.findViewById(R.id.ItemdefaultImage);
            mTextView = (TextView) itemView.findViewById(R.id.ItemText);
            ItemdefaultImage.setTag(itemView.getTag());
            ItemdefaultImage.setOnHoverListener(
                    new View.OnHoverListener() {
                        @Override
            ...
            mTextView.setOnFocusChangeListener(
