...
public class TrackSelectionHelper implements View.OnClickListener, DialogInterface.OnClickListener {
     ...
     * @param adaptiveVideoTrackSelectionFactory A factory for adaptive video {@link
     *     TrackSelection}s, or null if the selection helper should not support adaptive video.
     */
    ...
    public void showSelectionDialog(
            Activity activity, CharSequence title, MappedTrackInfo trackInfo, int rendererIndex) {
        ...
        for (int i = 0; i < trackGroups.length; i++) {
            trackGroupsAdaptive[i] =
                    adaptiveVideoTrackSelectionFactory != null
        ...
        for (int groupIndex = 0; groupIndex < trackGroups.length; groupIndex++) {
            ...
            for (int trackIndex = 0; trackIndex < group.length; trackIndex++) {
                ...
                CheckedTextView trackView =
                        (CheckedTextView) inflater.inflate(trackViewLayoutId, root, false);
    ...
    private void updateViews() {
        ...
        if (enableRandomAdaptationView != null) {
            ...
            if (enableView) {
                enableRandomAdaptationView.setChecked(
                        !isDisabled && override.factory instanceof RandomTrackSelection.Factory);
            }
        }
    }
    ...
    public void onClick(View view) {
        if (view == disableView) {
            ...
            setOverride(
                    override.groupIndex, override.tracks, !enableRandomAdaptationView.isChecked());
        } else {
            isDisabled = false;
            ...
            if (!trackGroupsAdaptive[groupIndex]
                    || override == null
                ...
                if (isEnabled) {
                    ...
                    if (overrideLength == 1) {
                        ...
                        setOverride(
                                groupIndex,
                                getTracksRemoving(override, trackIndex),
                    ...
                    setOverride(
                            groupIndex,
                            getTracksAdding(override, trackIndex),
                            enableRandomAdaptationView.isChecked());
                }
            }
        }
