...
public class FilterFragment extends BackHandledFragment {
    ...
    public static void scaleOut(View view) {
        ...
        Animator animator =
                AnimatorInflater.loadAnimator(view.getContext(), R.animator.scaleout_word);
    ...
    public static void scaleIn(View view) {
        ...
        Animator animator =
                AnimatorInflater.loadAnimator(view.getContext(), R.animator.scalein_word);
        animator.setTarget(view);
        animator.start();
    }
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (!"".equals(submitFilteStr) && conditions.size() > 0) {
                            submitFilteStr =
                                    submitFilteStr.substring(0, submitFilteStr.length() - 1);
                        }
                        ...
                        if ((!mChannel.equals("chinesemovie") || !mChannel.equals("overseas"))
                                && "".equals(submitFilteStr)) {
                            ...
                            public void onNext(ResponseBody responseBody) {
                                try {
                                    ...
                                    while (it.hasNext()) {
                                        ...
                                        View view =
                                                mInflater.inflate(
                                                        R.layout.filter_condition_item, null);
                                        TextView condition_txt =
                                                (TextView) view.findViewById(R.id.condition_txt);
                                        MyViewGroup valueViews =
                                                (MyViewGroup) view.findViewById(R.id.line_group);

                                        valueViews.setFocusable(true);
                                        valueViews.setFocusableInTouchMode(true);
                                        valueViews.setDescendantFocusability(
                                                ViewGroup.FOCUS_AFTER_DESCENDANTS);
                                        condition_txt.setText(label + " :");
                                        RadioButton nolimitRbtn =
                                                (RadioButton)
                                                        mInflater.inflate(
                                        ...
                                        if (nolimit.startsWith("area")
                                                && key.equals("area")
                                                && (mChannel.equals("chinesemovie")
                                                        || mChannel.equals("overseas"))) {
                                                ...
                                                new LinearLayout.LayoutParams(
                                                        getResources()
                                                                .getDimensionPixelSize(
                                                                        R.dimen.filter_radio_W),
                                                        getResources()
                                                                .getDimensionPixelSize(
                                                                        R.dimen.filter_radio_H)));
    ...
    private void initRadioButton(RadioButton rbtn) {
        ...
        rbtn.setOnCheckedChangeListener(
                new CompoundButton.OnCheckedChangeListener() {
                    @Override
                    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                        if (b) {
                            //  Toast.makeText(getActivity(),
                            // ((FilterItem)compoundButton.getTag()).value,
                            ...
                            if (((FilterItem) compoundButton.getTag()).nolimitView != null) {
                                if (((FilterItem) compoundButton.getTag()).nolimitView
                                        != compoundButton) {
                                    ((FilterItem) compoundButton.getTag())
                                            .nolimitView.setChecked(false);
                                }
                            }
                            ...
                            if (!str.equals("")) {
                                ...
                                if (!"不限".equals(s)) realNames.add(s);
                            }
                        } else {
                            ...
                            if (!"".equals(str)) {
                                ...
                                String s = ((FilterItem) compoundButton.getTag()).name;
                                if (!"不限".equals(s)) realNames.remove(s);
                            }
                        }
                    }
                });

        rbtn.setOnHoverListener(
                new View.OnHoverListener() {
                    @Override
