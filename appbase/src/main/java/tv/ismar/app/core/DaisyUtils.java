...
public class DaisyUtils {
    ...
    public static boolean gotoSpecialPage(
            final Context context, final String contentMode, final String url, final String from) {
        ...
        OfflineCheckManager.getInstance()
                .checkItem(
                        url,
                        new OfflineCheckManager.Callback() {
                            @Override
                            public void online() {
                                loadingDialog.dismiss();
                                ...
                                if ("variety".equals(contentMode)
                                        || "entertainment".equals(contentMode)) {
                            ...
                            public void offline() {
                                ...
                                gotoSuccess[0] = false;
                                showNetErrorPopup(
                                        context, context.getString(R.string.item_offline));
                            }
