...
public class OfflineCheckManager {
                ...
                .subscribe(
                        new Observer<ResponseBody>() {
                            ...
                            public void onNext(ResponseBody responseBody) {
                                ...
                                OfflineCheckEntity offlineCheckEntity =
                                        new Gson().fromJson(result, OfflineCheckEntity.class);
    ...
    public void checkItem(int pk, Callback callback) {
        ...
        SkyService skyService = SkyService.ServiceManager.getService();
        skyService
                .apiItemIsOffline(String.valueOf(pk))
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                        new Observer<OfflineCheckEntity>() {
                            @Override
                            public void onCompleted() {}
    ...
    public void checkPkg(int pk, Callback callback) {
        ...
        SkyService skyService = SkyService.ServiceManager.getService();
        skyService
                .apiPKGIsOffline(String.valueOf(pk))
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                        new Observer<OfflineCheckEntity>() {
