...
public class ChildFragment extends ChannelBaseFragment implements Flag.ChangeCallback {
    ...
    public View onCreateView(
        ...
        image_switcher_focus.setOnHoverListener(
        ...
        childMore.setOnFocusChangeListener(
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        if (channelEntity != null) fetchChild(channelEntity.getHomepage_url());
    }
                        ...
                        .subscribe(
                                ...
                                .new BaseObserver<HomePagerEntity>() {
                                    ...
                                    public void onNext(HomePagerEntity homePagerEntity) {
                                        if (mContext == null
                                                || leftLayout == null
                                                || rightLayout == null && bottomLayout == null)
                                            return;
                                        ...
                                        ArrayList<HomePagerEntity.Poster> posters =
                                                homePagerEntity.getPosters();
    ...
    private void initPosters(ArrayList<HomePagerEntity.Poster> posters) {
        ...
        for (int i = 0; i < 7; i++) {
            View itemContainer =
                    LayoutInflater.from(mContext).inflate(R.layout.item_comic_fragment, null);
            ...
            LabelImageView3 item_img_focus =
                    (LabelImageView3) itemContainer.findViewById(R.id.item_img_focus);
            ...
            if (i >= 0 && i < 3) {
                ...
                if (i < 2) {
                    item_img_focus.setOnFocusChangeListener(
                            new View.OnFocusChangeListener() {
    ...
    private void initCarousel(ArrayList<HomePagerEntity.Carousel> carousels) {
        ...
        View.OnFocusChangeListener itemFocusChangeListener =
                new View.OnFocusChangeListener() {
                    @Override
        ...
        for (int i = 0; i < 3; i++) {
            ...
            Picasso.with(mContext)
                    .load(carousels.get(i).getThumb_image())
                    .memoryPolicy(MemoryPolicy.NO_STORE)
                    .into(indicatorImgs[i]);
        }
    ...
    private void playCarousel() {
        messageHandler.removeMessages(0);
        image_switcher_focus.setTag(
                R.drawable.launcher_selector, carousels.get(flag.getPosition()));
        Picasso.with(mContext)
                .load(carousels.get(flag.getPosition()).getVideo_image())
                .memoryPolicy(MemoryPolicy.NO_STORE)
                .into(
                        imageSwitcher,
                        new Callback() {
                            int pauseTime =
                                    Integer.parseInt(
                                            carousels.get(flag.getPosition()).getPause_time());
