...
public class BaseActivity extends AppCompatActivity {
    ...
    private BroadcastReceiver onNetConnectReceiver =
            new BroadcastReceiver() {
                @Override
    ...
    public void showNetWorkErrorDialog(Throwable e) {
        ...
        netErrorPopWindow.setOnDismissListener(
                new PopupWindow.OnDismissListener() {
                    @Override
                    public void onDismiss() {
                        if (!(act.contains("HomePageActivity")
                                || act.contains("WordSearchActivity")
                                || act.contains("FilmStar")
                                || act.contains("UserCenterActivity"))) {
                            finish();
                        }
                    }
                });
        try {
            netErrorPopWindow.showAtLocation(
                    getRootView(),
                    Gravity.CENTER,
                    0,
                    0,
    ...
    public void showExpireAccessTokenPop() {
        ...
        expireAccessTokenPop.setOnDismissListener(
                new PopupWindow.OnDismissListener() {
                    @Override
                    public void onDismiss() {
        ...
        expireAccessTokenPop.showAtLocation(
                getRootView(),
                Gravity.CENTER,
                0,
                0,
    ...
    public void showItemOffLinePop() {
        ...
        itemOffLinePop.setOnDismissListener(
                new PopupWindow.OnDismissListener() {
                    @Override
                    public void onDismiss() {
                        finish();
    ...
    public abstract class BaseObserver<T> implements Observer<T> {
        ...
        public void onError(Throwable e) {
            ...
            if (!NetworkUtils.isConnected(BaseActivity.this)
                    && !NetworkUtils.isWifi(BaseActivity.this)) {
