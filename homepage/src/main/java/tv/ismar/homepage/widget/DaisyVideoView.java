 ...
 * tinting.
 */
public class DaisyVideoView extends SurfaceView implements MediaPlayerControl {
    ...
    MediaPlayer.OnInfoListener mInfoChangedListener =
    ...
    MediaPlayer.OnSeekCompleteListener mSeekCompleteChangedListener =
    ...
    private void openVideo() {
        ...
        try {
            ...
            // mHeaders.put("User-Agent", Build.MODEL+"/"+SimpleRestClient.appVersion+"
