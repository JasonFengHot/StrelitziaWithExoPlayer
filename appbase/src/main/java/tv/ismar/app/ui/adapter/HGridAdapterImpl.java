...
public class HGridAdapterImpl extends HGridAdapter<ItemCollection>
                ...
                if (this.template == 1)
                    convertView =
                            LayoutInflater.from(mContext)
                                    .inflate(R.layout.list_view_variety_no_month_item, null);
                else if (this.template == 2)
                    convertView =
                            LayoutInflater.from(mContext)
                                    .inflate(R.layout.list_view_variety_month_item, null);
                else
                    convertView =
                            LayoutInflater.from(mContext).inflate(R.layout.list_view_item, null);
            } else
                convertView =
                        LayoutInflater.from(mContext).inflate(R.layout.list_portrait_item, null);
            holder = new Holder();
            holder.title = (TextView) convertView.findViewById(R.id.list_item_title);
            holder.previewImage =
                    (LabelImageView) convertView.findViewById(R.id.list_item_preview_img);
            holder.qualityLabel =
                    (ImageView) convertView.findViewById(R.id.list_item_quality_label);
                ...
                if (item != null) {
                    ...
                    if (isPortrait) {
                        ...
                        if (template == 1 || template == 2) {
                            if (item.focus != null) holder.previewImage.setFocustitle(item.focus);
