...
public class CallaPlay {
    ...
    private HashMap<String, Object> getPublicParams(
            IsmartvMedia media, int speed, String sid, String playerFlag) {
     ...
     * 播放器打开 video_start
     *
     * @param media (媒体) Item quality (视频清晰度 normal medium high ultra adaptive) STRING
     * @param userId (用户ID) STRING
     * @param speed (网速, 单位KB/s) INTEGER
     * @return HashMap
     */
    public HashMap<String, Object> videoStart(
            IsmartvMedia media, String userId, int speed, String sid, String playerFlag) {
        if (media == null) {
            return null;
        }
        userId =
     ...
     *
     * @param media (媒体)Item quality (视频清晰度)normal | medium | high | ultra | adaptive |
     *     adaptive_norma l | adaptive_medium | adaptive_high | adaptive_ultra) STRING
     * @param duration (缓存时间,单位s)INTEGER
     * @param speed (网速,单位KB/s)INTEGER
     * @param mediaIP (媒体IP)STRING
     * @return HashMap
     */
    public HashMap<String, Object> videoPlayLoad(
            IsmartvMedia media,
            long duration,
            int speed,
            String mediaIP,
     ...
     * @return HashMap
     */
    public HashMap<String, Object> videoPlayStart(
            IsmartvMedia media, int speed, String sid, String playerFlag) {
        if (media == null) {
            return null;
        }
     ...
     * @return HashMap
     */
    public HashMap<String, Object> videoPlayPause(
            IsmartvMedia media, int speed, Integer position, String sid, String playerFlag) {
        if (media == null) {
            return null;
        }
        HashMap<String, Object> tempMap = getPublicParams(media, speed, sid, playerFlag);
     ...
     * @return HashMap
     */
    public HashMap<String, Object> videoPlayContinue(
            IsmartvMedia media, int speed, Integer position, String sid, String playerFlag) {
        if (media == null) {
            return null;
        }
     ...
     * @return HashMap
     */
    public HashMap<String, Object> videoPlaySeek(
            IsmartvMedia media, int speed, Integer position, String sid, String playerFlag) {
        if (media == null) {
            return null;
        }
     ...
     * @return HashMap
     */
    public HashMap<String, Object> videoPlaySeekBlockend(
            IsmartvMedia media,
            int speed,
            Integer position,
            long duration,
     ...
     *
     * @param media (媒体) Item quality (视频清晰度: normal | medium | high | ultra | adaptive |
     *     adaptive_normal | adaptive_medium | adaptive_high | adaptive_ultra) STRING
     * @param speed (网速, 单位KB/s) INTEGER
     * @param duration (缓存时间,单位s) INTEGER
     * @param mediaIP (媒体IP)STRING
     * @return HashMap
     */
    public HashMap<String, Object> videoPlayBlockend(
            IsmartvMedia media,
            int speed,
            long duration,
            String mediaIP,
     ...
     *
     * @param media (媒体) INTEGER quality (视频清晰度: normal | medium | high | ultra | adaptive) STRING
     * @param speed (网速, 单位KB/s) INTEGER
     * @param mediaIP (媒体IP) STRING
     * @return HashMap
     */
    public HashMap<String, Object> videoPlaySpeed(
            IsmartvMedia media, int speed, String mediaIP, String sid, String playerFlag) {
        if (media == null) {
            return null;
        }
        HashMap<String, Object> tempMap = getPublicParams(media, speed, sid, playerFlag);
     ...
     * @return HashMap
     */
    public HashMap<String, Object> videoLowSpeed(
            IsmartvMedia media, int speed, String mediaIP, String sid, String playerFlag) {
        if (media == null) {
            return null;
        }
     ...
     * @return HashMap
     */
    public HashMap<String, Object> videoExit(
            IsmartvMedia media,
            int speed,
            String to,
            Integer position,
     ...
     *
     * @param code
     *     (异常码servertimeout|servertimeout|noplayaddress|mediaexception|mediatimeout|filenotfound|nodetail|debuggingexception|noextras)
     *     STRING
     * @param content (异常内容) STRING
     * @param media (媒体) INTEGER quality (视频清晰度: normal | medium | high | ultra | adaptive |
     *     adaptive_normal | adaptive_medium | adaptive_high | adaptive_ultra) STRING
     * @param position (播放位置，单位s) INTEGER
     * @return HashMap
     */
    public HashMap<String, Object> videoExcept(
            String code,
            String content,
            IsmartvMedia media,
            int speed,
     ...
     * @return HashMap
     */
    public HashMap<String, Object> videoSwitchStream(
            IsmartvMedia media,
            String mode,
            int speed,
            String userid,
    ...
    public void ad_play_load(
            IsmartvMedia media, long duration, String mediaip, int ad_id, String mediaflag) {
        if (media == null) {
            return;
        }
    ...
    public void pause_ad_play(
            String title, int media_id, String media_url, long duration, String mediaflag) {
        HashMap<String, Object> tempMap = new HashMap<String, Object>();
    ...
    public void homepage_vod_click(
            int pk, String title, String channel, Integer position, String type) {
        HashMap<String, Object> tempMap = new HashMap<String, Object>();
