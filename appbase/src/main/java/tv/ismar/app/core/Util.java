...
public class Util {
	...
	public static boolean isNetConnected(Context context) {
		...
		try {
			...
			ret = con.getNetworkInfo(ConnectivityManager.TYPE_MOBILE)
					.isConnected();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static void setBooleanValue(Context context, String key,
			boolean value) {
		SharedPreferences prefs = context.getSharedPreferences("iamhere",
    ...
    * @return Բ��ͼƬ
    */
	public static Bitmap createRoundPhoto(int x, int y, Bitmap image,
    	...
    	for (RunningAppProcessInfo appProcessInfo : appProcessInfos) {
    		...
    		if (processName.equals(name)) {
    			if(appProcessInfo.importance == RunningAppProcessInfo.IMPORTANCE_FOREGROUND){
					...
					System.out.println("foreground process: "
